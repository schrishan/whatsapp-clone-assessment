...
import '../styles/chat-board-header.scss';
import { ActiveContactType } from "../types/type";

interface Props {
    data: ActiveContactType;
}

const ChatBoardHeader = (props: Props) => {
